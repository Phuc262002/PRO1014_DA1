            ...
            <div class="col-md-6 align-self-center m-b-30" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div class="about-content">
                    ...
                    <ul class="about-content-list">
                        ...
                        <li><span><i class="ti-angle-double-right"></i></span> Trái ngược với niềm tin phổ biến không chỉ đơn giản là</li>
                        <li><span><i class="ti-angle-double-right"></i></span> Nhưng tôi phải giải thích cho bạn làm thế nào tất cả những điều này</li>
                    </ul>
                    <a href="contact.html" class="btn btn-primary btn-hover-dark">Liên hệ với chúng tôi</a>
                </div>
                <!-- About Content End -->
            </div>
        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="testimonial-thumb text-center">
                                    ...
                                    <h3 class="thumb-title">Hoàng Phúc</h3>
                                    <h6 class="thumb-subtitle">Customer</h6>
                                </div>
                                <!-- Testimonial Thumb End -->
                            </div>
