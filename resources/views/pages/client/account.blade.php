                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Pending</td>
                                                        <td>$3000</td>
                                                        <td><a href="cart.html" class="btn btn btn-dark btn-hover-primary btn-sm rounded-0">Xem</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>22.7.2018</td>
                                        ...
                                        <div class="account-details-form">
                                            <form action="#">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="single-input-item m-b-15">
                                                        <label for="current-pwd" class="required m-b-10">Mật khẩu hiển thị</label>
                                                        <input type="password" id="current-pwd" placeholder="Mật khẩu hiển thị" />
                                                    </div>
                                                    <div class="row m-b-n15">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="single-input-item m-b-15">
                                                                ...
                                                                <input type="password" id="confirm-pwd" placeholder="Nhập lại mật khẩu" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </fieldset>
