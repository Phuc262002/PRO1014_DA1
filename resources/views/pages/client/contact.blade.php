...
@section('content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-area m-b-20">
                                                <input class="input-item" type="text" placeholder="Họ và Tên *"
                                                    name="name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="input-area m-b-20">
                                                <input class="input-item" type="text" placeholder="Địa Chỉ *"
                                                    name="subject">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" id="submit" name="submit"
                                                class="btn btn-primary btn-hover-dark">Gửi phản hồi</button>
                                        </div>
                ...
                <div class="col-12 col-lg-6 m-b-50 order-1 order-lg-2" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div class="contact-content">
                        ...
                        <address class="contact-block">
                            <ul>
                                <li><i class="fa fa-envelope-o"></i> <a href="mailto:demo@example.com">petscare@gmail.com
                                    </a>
                                </li>
                            </ul>
                        </address>
    ...
    <div class="section">
        ...
        <div class="google-map-area w-100" data-aos="fade-up" data-aos-duration="1000">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.444049623341!2d106.62348867490896!3d10.853791489299727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752b684ce076f3%3A0x4da1cf0078f423fa!2zRlBUIFBvbHl0ZWNobmljIEjhu5MgQ2jDrSBNaW5oIC0gVG_DoCBU!5e0!3m2!1sen!2s!4v1689148274286!5m2!1sen!2s"
