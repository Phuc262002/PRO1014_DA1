                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $book_service_count->sum('total_price') }}">0</span> VNĐ
                                        </h4>
                                        <span class="badge bg-warning me-1">{{ count($book_service_count) }}</span> <span
                                            class="text-muted">
                                            Dịch vụ</span>
                                    </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $book_service_pending->sum('total_price') }}">0</span> VNĐ
                                        </h4>
                                        <span class="badge bg-warning me-1">{{ count($book_service_pending) }}</span> <span
                                            class="text-muted">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $book_service_cancel->sum('total_price') }}">0</span> VNĐ
                                        </h4>
                                        <span class="badge bg-warning me-1">{{ count($book_service_cancel) }}</span> <span
                                            class="text-muted">Dịch vụ đã hủy
                                        </span>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-light rounded fs-3">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $book_service_complete->sum('total_price') }}">0</span> VNĐ
                                        </h4>
                                        <span class="badge bg-warning me-1">{{ count($book_service_complete) }}</span> <span
                                            class="text-muted"> Dịch vụ
                                        </span>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-light rounded fs-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-xxl-3 col-sm-4">
                                            <input type="text" class="form-control bg-light border-light"
                                                data-date-format="d-m-y" value="{{ $calendar }}" name="calendar"
                                    ...
                                    <div class="table-responsive table-card">
                                            ...
                                            <tbody class="list form-check-all" id="invoice-list-data">
                                                @foreach ($book_service as $item)
                                                    <tr>
                                                        ...
                                                        <td class="id"><a href="" onclick="ViewInvoice(this);"
                                                                data-id="{{ $item->book_service_hash_id }}"
                                                                class="fw-medium link-primary">{{ $item->book_service_hash_id }}</a>
                                                        ...
                                                        <td class="service">{{ number_format($item->total_price) }} VNĐ
                                                        </td>
                                                        <td class="book_date"><small
                                                                class="text-muted"></small>{{ $item->book_date }}</td>
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="text-center">
                                                ...
                                                <h4>
                                                    <p class="text-muted mb-0">Chúng tôi không tìm thấy đơn hàng từ thông
                                                        tin bạn cung cấp.</p>
                                                </h4>
                                            </div>
                                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" autocomplete="off"
                            action="{{ route('book-service.update', ['book_service' => $item->id]) }}" method="post"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ $item->user->name }}"
                                        disabled />
                                </div>

                                <div class="mb-3">
                                    <label for="customername-field" class="form-label">Email:</label>
                                    <input type="text" class="form-control" placeholder="{{ $item->user->email }}"
                                        disabled />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ number_format($item->total_price) }} VNĐ" disabled />
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <select class="form-control" data-choices data-choices-search-false name="status"
                                        ...
                                        <option {{ $item->status == 'ACCEPTED' ? 'selected' : '' }} value="ACCEPTED">Dịch
                                            vụ
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success" id="add-btn">Cập nhật thông
                                        tin</button>
                                </div>
                            </div>
                        </form>
