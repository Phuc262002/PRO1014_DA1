                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($item->confirm == true)
                                                                        <span class="badge badge-soft-info">Đã xác
                                                                            thực</span>
                                                                    @else
                                                                        <span class="badge badge-soft-warning">Chưa xác
                                                                            thực</span>
                                                                    @endif
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="pagination-wrap hstack gap-2">
                                                    ...
                                                    <div class="noresult" style="display: none">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="text-muted mb-0">Bạn vui lòng ấn áp dụng đề tìm kiếm
                                                                trên toàn hện thống.</p>
                                                            >>>>>>> 3c6dd10e0a4024d8792954d8fab7b8657b7e5f4d
                                                        </div>
                                                    </div>
                                                </div>
                                                @foreach ($users as $item)
                                                    <div class="modal fade" id="showModal{{ $item->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('user.update', ['user' => $item->id]) }}"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="fullnameInput" name="name"
                                                                                value="{{ $item->name }}"
                                                                                placeholder="Enter your name">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label
                                                                                for="inlineFormInputGroupUsername">Email</label>
                                                                        ...
                                                                        <!--end col-->
                                                                        <div class="mb-3">
                                                                            <label for="inputState" class="form-label">Vai
                                                                                trò</label>
                                                                            <select id="inputState" class="form-select"
                                                                                data-choices name="is_admin"
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="inputState" class="form-label">Xác
                                                                                thực</label>
                                                                            <select id="inputState" class="form-select"
                                                                                data-choices name="confirm"
                                                                                data-choices-sorting="true">
                                                                                @if ($item->confirm == true)
                                                                                    <option selected value="1">Đã xác
                                                                                        thực
                                                                                    </option>
                                                                                    <option value="0">Chưa xác thực
                                                                                    </option>
                                                                                @else
                                                                                    <option value="1">Đã xác thực
                                                                                    </option>
                                                                                    <option selected value="0">Chưa
                                                                                        xác thực
                                                                                    </option>
                                                                                @endif
                                                                            </select>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <select id="inputState" class="form-select"
                                                                                ...
                                                                                data-choices-sorting="true">
                                                                                @if ($item->status == true)
                                                                                    <option selected value="1">Hoạt
                                                                                        động</option>
                                                                                    <option value="0">Bị chặn</option>
                                                                                @else
                                                                                    <option value="1">Hoạt động
                                                                                    </option>
                                                                                    <option selected value="0">Bị chặn
                                                                                    </option>
                                                                                @endif
                                                                            </select>
                                                                        </div>
