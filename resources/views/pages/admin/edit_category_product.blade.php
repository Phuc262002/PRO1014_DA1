                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">CẬP NHẬP DANH MỤC SẢN PHẨM</h4>
                            </div><!-- end card header -->
                            <div class="card-body">
                                @if (session('success'))
                                ...
                                <div class="live-preview">
                                    <form id="form_edit" action="{{ route('category-product.update', ['category_product' => $category->id]) }}" method="POST"
