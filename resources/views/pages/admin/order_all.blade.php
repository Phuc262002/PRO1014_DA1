                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $order_count->sum('total') }}">0</span> VNĐ</h4>
                                        <span class="badge bg-warning me-1">{{ count($order_count) }}</span> <span
                                            class="text-muted">Đơn hàng</span>
                                    </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $order_cancel->sum('total') }}">0</span> VNĐ</h4>
                                        <span class="badge bg-warning me-1">{{ count($order_cancel) }}</span> <span
                                            class="text-muted">Đơn đã hủy</span>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-light rounded fs-3">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $order_complete->sum('total') }}">0</span> VNĐ</h4>
                                        <span class="badge bg-warning me-1">{{ count($order_complete) }}</span> <span
                                            class="text-muted"> Đơn hàng</span>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-light rounded fs-3">
                                            ...
                                            <div class="input-light">
                                                <select class="form-control" data-choices data-choices-search-false
                                                    ...
                                                    <option {{ $status == 'ALL' ? 'selected' : '' }} value="ALL"
                                                        selected>Tất cả đơn hàng</option>
                                            ...
                                            <tbody class="list form-check-all" id="invoice-list-data">
                                                @foreach ($order as $item)
                                                    <tr>
                                                        ...
                                                        <td class="date"><small
                                                                class="text-muted">{{ $item->created_at }}</small></td>
                                                        <td class="invoice_amount">{{ number_format($item->total) }} VNĐ
                                                        </td>
                                                        <td class="status">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" autocomplete="off"
                            action="{{ route('orders.update', ['order' => $item->id]) }}" method="post"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ $item->coupon != null ? number_format($item->coupon->discount) : '' }} "
                                        disabled />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ number_format($item->total) }} VNĐ" disabled />
                                </div>
