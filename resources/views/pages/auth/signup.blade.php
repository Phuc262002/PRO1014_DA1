            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate action="https://themesbrand.com/velzon/html/material/index.html">
                                        ...
                                        <div class="mb-4">
                                            <p class="mb-0 fs-12 text-muted fst-italic">Bằng cách đăng ký, bạn đồng ý với Pets Care  <a href="#" class="text-primary text-decoration-underline fst-normal fw-medium"> Điều khoản sử dụng</a></p>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Đã có tài khoản ? <a href="auth-signin-basic.html" class="fw-semibold text-primary text-decoration-underline"> Đăng nhập </a> </p>
                        </div>
