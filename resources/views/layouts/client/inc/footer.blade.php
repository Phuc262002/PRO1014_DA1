             ...
             <div class="row m-b-n40">
                 <div class="col-12 col-sm-6 col-lg-3 m-b-40" data-aos="fade-up" data-aos-duration="1000">
                     <div class="single-footer-widget">
                         ...
                         <p class="desc-content">PetCare cung cấp dịch vụ chăm sóc răng nhằm phòng và điều trị các bệnh
                             về răng miệng cho vật nuôi. </p>
                         <!-- Soclial Link Start -->
                 ...
                 <div class="col-12 col-sm-6 col-lg-3 m-b-40" data-aos="fade-up" data-aos-duration="1600">
                     <div class="single-footer-widget">
                         ...
                         <div class="widget-body">
                             <p class="desc-content m-b-20">Đăng ký nhận bản tin của chúng tôi và nhận 10% giảm giá mua
                             ...
                             <div class="newsletter-form-wrap p-t-5">
                                 <form id="mc-form" class="mc-form">
                                     <input type="email" id="mc-email" class="form-control email-box"
                                         placeholder="petscare@gmail.com" name="EMAIL">
                     ...
                     <div class="col-lg-12">
                         <div class="text-center">
                             <p class="mb-0 text-muted">&copy;
                                 ...
                                 </script> Pets Care <i class="mdi mdi-heart text-danger"></i>
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 return `
                           <div class="cart-product-inner p-b-20 m-b-20 border-bottom">
                               ...
                               <div class="cart-product-remove">
                                   <a href="javascript:deleteCartHeader(${item.id})"><i class="icon-close"></i></a>
                               </div>
                           </div>`;
             });
